...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">Smalt and Beryl Admin</a>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Manage Posts <i class="fa fa-fw fa-caret-down"></i></a>
                <ul id="demo" class="collapse">
                    <li>
                        <a href="viewallposts.php"> View all Posts</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul id="users" class="collapse">
                    <li>
                        <a href="./users.php?source=addusers">Add User</a>
                    </li>
                    <li>
                        <a href="./users.php?source=viewallusers">View All Users</a>
                    </li>
                </ul>
            </li>
